-- 0042 — add 'booking_alert' to notification_type.
--
...
-- the admin bell. Apply 0041 first, then this.
...
--   psql "$PRODUCTION_DATABASE_URL" -f db/supabase/migrations/0042_notification_booking_alert.sql
